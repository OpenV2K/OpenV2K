...
**Features as of Version 103**: Audio Waveform Zero-Crossing Detection, SDR Pulse Modulation Output, Raw IQ Recording, Waterfall Spectrogram Generation, Live Microphone Input, eSpeak/MBROLA Text-To-Speech Engine, Signal Conditioning Filters, Noise Filters, Pulse Shaping Filters, Rectangular Pulses, Live Duty Cycle Meter, Adjustable Pulse Width, Adjustable High Pass and Low Pass Filters, Automatic High Power Calculator, Event Log, Dependency Checks, and 49 Languages Supported.  
