...
I adopted the term "V2K" from the US Army: [from a 2008 WIRED magazine article](https://www.wired.com/2008/05/army-removes-pa/). I'm validating the term, with [FOSS](https://en.wikipedia.org/wiki/Free_and_open-source_software) RF engineering, so [quacks](https://en.wikipedia.org/wiki/Quackery) cannot continue their health fraud, on targeted civilians. I've recreated in software, what has come before, in lab hardware. **How is this RF hacking?** It's a [vulnerability](https://en.wikipedia.org/wiki/Vulnerability_\(computer_security\)) disclosure that applies to all of humanity. There is no firmware patch. Do you care yet?  
