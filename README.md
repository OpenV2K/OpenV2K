...
HackRF One SDR via gr-osmosdr, or saves the raw IQ samples to disk, and generates a waterfall graph image.  
  ...
  ![StandBackImTryingScience](https://github.com/OpenV2K/Sandbox/blob/main/_emot-science.gif?raw=true)  **Check the Sandbox for screenshots and [pre-alpha](https://en.wikipedia.org/wiki/Software_testing#Alpha_testing) software**: https://github.com/OpenV2K/Sandbox  
